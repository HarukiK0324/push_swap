...
void	store_cmd(char *cmd)
{
	...
	{
		if ((ft_strcmp(prev_cmd, "ra") == 0 && ft_strcmp(cmd, "rb") == 0)
			|| (ft_strcmp(prev_cmd, "rb") == 0 && ft_strcmp(cmd, "ra") == 0))
			prev_cmd = init_string("rr\n", prev_cmd);
		else if ((ft_strcmp(prev_cmd, "rra") == 0 && ft_strcmp(cmd, "rrb") == 0)
			|| (ft_strcmp(prev_cmd, "rrb") == 0 && ft_strcmp(cmd, "rra") == 0))
